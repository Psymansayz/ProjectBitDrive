(function(f){if(typeof exports==='object'&&typeof module!=='undefined'){module.exports=f()}else if(typeof define==='function'&&define.amd){define([],f)}else{let g;if(typeof window!=='undefined'){g=window}else if(typeof global!=='undefined'){g=global}else if(typeof self!=='undefined'){g=self}else{g=this}g.hqx = f()}})(() => {let define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){const a=typeof require=='function'&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);const f=new Error(`Cannot find module '${o}'`);throw f.code='MODULE_NOT_FOUND',f}const l=n[o]={exports:{}};t[o][0].call(l.exports,(e) => {const n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=='function'&&require;for(let o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
  ...
  const _Interp1 = function( pc, c1, c2 ) {
    //*pc = (c1*3+c2) >> 2;
    if (c1 === c2) {
      _dest[pc] = c1
      return
  ...
  const _Interp2 = function( pc, c1, c2, c3 ) {
    //*pc = (c1*2+c2+c3) >> 2;
  ...
  const _Interp3 = function( pc, c1, c2 ) {
    //*pc = (c1*7+c2)/8;
    if (c1 === c2) {
      _dest[pc] = c1
      return
  ...
  const _Interp4 = function( pc, c1, c2, c3 ) {
    //*pc = (c1*2+(c2+c3)*7)/16;
  ...
  const _Interp5 = function( pc, c1, c2 ) {
    //*pc = (c1+c2) >> 1;
    if (c1 === c2) {
      _dest[pc] = c1
      return
  ...
  const _Interp6 = function( pc, c1, c2, c3 ) {
    //*pc = (c1*5+c2*2+c3)/8;
  ...
  const _Interp7 = function( pc, c1, c2, c3 ) {
    //*pc = (c1*6+c2+c3)/8;
  ...
  const _Interp8 = function( pc, c1, c2 ) {
    //*pc = (c1*5+c2*3)/8;
    if (c1 === c2) {
      _dest[pc] = c1
      return
  ...
  const _Interp9 = function( pc, c1, c2, c3 ) {
    //*pc = (c1*2+(c2+c3)*3)/8;
  ...
  const _Interp10 = function( pc, c1, c2, c3 ) {
    //*pc = (c1*14+c2+c3)/16;
  ...
  const getVendorAttribute = function( el, attr ) {
  ...
  const getImagePixels = function( image, x, y, width, height ) {
    ...
    let realWidth = image.width / ratio,
  ...
  module.exports = function hqx( img, scale ) {
    ...
    let orig, origCtx, scaled, origPixels
    ...
    let c, a, destLength = dest.length
